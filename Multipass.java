...
public class Multipass
{
	...
	private static String API_KEY = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"; // you'll find the multipass key in your admin
	...
	public static void main(String[] args)
	{
		try {
	      ...
	      userData.put("customer_email", "john@example.com");
	      ...
	      System.out.println("URL: https://" + SITE_KEY + ".desk.com/customer/authentication/multipass/callback?multipass=" + multipassString + "&signature=" + signatureString);
	    } catch (Exception e) {
	      e.printStackTrace();
	    }
	}
